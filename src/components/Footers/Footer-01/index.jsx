...
const index = () => {
  ...
  return (
    <footer className="mt-4 w-[80vw] max-w-[1400px]">
      <div className="flex justify-around gap-4 mb-6 flex-wrap border-b border-gray-500 pb-6 flex-col-reverse md:flex-row">
        <div className="flex flex-col gap-2">
          <img
            ...
            className="w-[10rem]"
          />
          <p className="text-gray-600">Take your platform to next level</p>
      ...
      <div className="text-center text-gray-500 mb-2">© copyright@2023</div>
    </footer>
  );
};
