...
const FeatureCard = (props) => {
  return (
    <div className="p-[20px] rounded-lg w-[320px] ">
      <div className="border  w-fit p-[5px] rounded-full mb-[20px] bg-blue-100">
        <svg
      ...
      <h2 className="text-md text-left font-semibold my-[0.3em]">
        {props.title}
      </h2>
      <p className="text-gray-700 text-md font-regular">{props.description}</p>
    </div>
  );
};
